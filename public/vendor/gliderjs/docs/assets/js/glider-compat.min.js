      ...
      if ('Element' in b) {
        ...
        var d = Object,
          ...
          k = function (a) {
            ...
            f = f ? f.split(/\s+/) : [];
            for (var b = 0, h = f.length; h > b; b++) this.push(f[b]);
        ...
        if (
          ...
          e = { get: m, enumerable: !0, configurable: !0 };
          try {
            d.defineProperty(b, 'classList', e);
          } catch (l) {
            (void 0 !== l.number && -2146823252 !== l.number) ||
              ((e.enumerable = !1), d.defineProperty(b, 'classList', e));
          }
        } else
          d.prototype.__defineGetter__ && b.__defineGetter__('classList', m);
      }
    })(self),
  (function () {
    ...
    if ((b.classList.add('c1', 'c2'), !b.classList.contains('c2'))) {
      var d = function (a) {
        ...
        DOMTokenList.prototype[a] = function (a) {
          var c,
            h = arguments.length;
          for (c = 0; h > c; c++) (a = arguments[c]), b.call(this, a);
        };
      };
      d('add');
      d('remove');
...
(function () {
  if ('undefined' !== typeof window)
    try {
      var b = new window.CustomEvent('test', { cancelable: !0 });
      b.preventDefault();
    ...
    value: function (b) {
      ...
      for (var d = Object(b), g = 1; g < arguments.length; g++) {
        ...
        if (void 0 !== a && null !== a) {
          a = Object(a);
          for (
            var c = Object.keys(Object(a)), h = 0, k = c.length;
            h < k;
            h++
          ) {
            var e = c[h],
...
(function () {
  for (
    var b = 0, d = ['ms', 'moz', 'webkit', 'o'], g = 0;
    g < d.length && !window.requestAnimationFrame;
    ++g
  )
    (window.requestAnimationFrame = window[d[g] + 'RequestAnimationFrame']),
      (window.cancelAnimationFrame =
        window[d[g] + 'CancelAnimationFrame'] ||
        window[d[g] + 'CancelRequestAnimationFrame']);
